...
d3.json('/data').then(function(data) {
    ...
    tableData = JSON.parse(JSON.stringify(data, ['Investigation_type', 'Date', 'Location' ,'Airport', 'Country', 'Air_carrier', 'Make', 'Fatalities', 'Uninjured', 'injuries']));
